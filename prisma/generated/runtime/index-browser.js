		...
		: ((n = r.abs().cmp(1)),
			...
			n !== -1
				...
				: ((s.precision = i + 6),
					(s.rounding = 1),
					(r = r
						.div(new s(1).minus(r.times(r)).sqrt().plus(1))
						.atan()),
					(s.precision = i),
					(s.rounding = t),
					r.times(2)))
...
h.toNearest = function (e, n) {
	...
	if (((i = new t(i)), e == null)) {
		...
		if (
			((e = new t(e)), n === void 0 ? (n = t.rounding) : _(n, 0, 8), !i.d)
		)
			return e.s ? i : e
...
function mn(e, n) {
	...
	return (
		!e.s || !n.s
			? (i = new this(NaN))
			: !e.d && !n.d
				? ((i = L(this, s, 1).times(n.s > 0 ? 0.25 : 0.75)),
					(i.s = e.s))
				: !n.d || e.isZero()
