...
var bi = Ge(Ke => {
	...
	function ai(e, t, r) {
		...
		if (
			...
			(typeof SharedArrayBuffer < 'u' &&
				(me(e, SharedArrayBuffer) ||
					(e && me(e.buffer, SharedArrayBuffer))))
		)
			return ui(e, t, r)
		if (typeof e == 'number')
			throw new TypeError(
	...
	function bt(e, t, r) {
		throw Math.floor(e) !== e
			? (He(e, r),
				new Qe.ERR_OUT_OF_RANGE(r || 'offset', 'an integer', e))
			: t < 0
...
C.minus = C.sub = function (e) {
	...
	if (((r = Z(e.e / O)), (g = Z(S.e / O)), (f = f.slice()), (o = g - r), o)) {
		...
		for (
			n = f.length, s = v.length, h = n < s, h && (s = n), n = 0;
			n < s;
			n++
		)
			if (f[n] != v[n]) {
...
function yl(e, t) {
	...
	return (
		!e.s || !t.s
			? (r = new this(NaN))
			: !e.d && !t.d
				? ((r = ce(this, o, 1).times(t.s > 0 ? 0.25 : 0.75)),
					(r.s = e.s))
				: !t.d || e.isZero()
					? ((r = t.s < 0 ? ce(this, n, i) : new this(0)),
						(r.s = e.s))
					: !e.d || t.isZero()
