	...
	we = (e, t, r) => {
		...
		if (zn(e)) {
			...
			if (Array.isArray(e)) {
				...
				return (
					e.length === t.length && e.every((s, a) => we(s, t[a], r))
				)
			}
			return Reflect.ownKeys(e).every(n => {
				...
				return (
					(n in t ||
						(Vr((o = i)) && o[Ne]().matcherType === 'optional')) &&
					we(i, t[n], r)
				)
				var o
			})
	...
	toString() {
		let { config: t } = this,
			...
			n = JSON.parse(
				JSON.stringify({
					provider: r,
					binaryTargets: Tc(t.binaryTargets)
				})
			)
...
function Hc(e, t) {
	...
	return (
		!e.s || !t.s
			? (r = new this(NaN))
			: !e.d && !t.d
				? ((r = ge(this, o, 1).times(t.s > 0 ? 0.25 : 0.75)),
					(r.s = e.s))
				: !t.d || e.isZero()
					? ((r = t.s < 0 ? ge(this, n, i) : new this(0)),
						(r.s = e.s))
					: !e.d || t.isZero()
...
var Sp = e => e,
	...
	x = {
		...
		util: {
			...
			objId: function (e) {
				return (
					e.__id || Object.defineProperty(e, '__id', { value: ++Ap }),
					e.__id
				)
			},
...
${a.backtrace}`,
	...
	getExternalAdapterError(t) {
		if (t.error_code === Pm && this.config.adapter) {
			...
			return (
				zr(n, 'External error with reported id was not registered'), n
			)
		}
	}
	async metrics(t) {
