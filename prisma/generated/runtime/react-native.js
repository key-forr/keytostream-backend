...
var yi = Re(Xe => {
	...
	function Pt(e, t, r) {
		throw Math.floor(e) !== e
			? (Ze(e, r),
				new ze.ERR_OUT_OF_RANGE(r || 'offset', 'an integer', e))
			: t < 0
...
R.minus = R.sub = function (e) {
	...
	if (
		((r = ee(e.e / I)), (g = ee(S.e / I)), (u = u.slice()), (o = g - r), o)
	) {
		for (
			h = o < 0,
				h
...
R.plus = R.add = function (e) {
	...
	if (
		((o = ee(h.e / I)), (n = ee(e.e / I)), (u = u.slice()), (i = o - n), i)
	) {
		for (
			i < 0
				? ((r = u), (i = -i), (s = g.length))
...
function jl(e, t) {
	...
	return (
		!e.s || !t.s
			? (r = new this(NaN))
			: !e.d && !t.d
				? ((r = de(this, o, 1).times(t.s > 0 ? 0.25 : 0.75)),
					(r.s = e.s))
				: !t.d || e.isZero()
					? ((r = t.s < 0 ? de(this, n, i) : new this(0)),
						(r.s = e.s))
					: !e.d || t.isZero()
...
var bu = e => e,
	...
	N = {
		...
		util: {
			...
			objId: function (e) {
				return (
					e.__id || Object.defineProperty(e, '__id', { value: ++Eu }),
					e.__id
				)
			},
...
${a.backtrace}`,
	...
	getExternalAdapterError(t) {
		if (t.error_code === tp && this.config.adapter) {
			...
			return (
				or(n, 'External error with reported id was not registered'), n
			)
		}
	}
	async metrics(t) {
...
function Qr(e) {
	...
	for (let n = 0; n < e.rows.length; n++) {
		...
		for (let s = 0; s < i.length; s++)
			o[e.columns[s]] = Ke(e.types[s], i[s])
		t.push(o)
	}
	return t
}
